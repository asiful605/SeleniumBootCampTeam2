...
public class Delta_AirlineHomePage extends WebAPI {
    ...
    public WebElement handleCookies;
    ...
    @FindBy(how = How.CSS, using = selectLocationWebElement)
    public WebElement selectLocation;
    @FindBy(how = How.CSS, using = notificationsButtonWebElement)
    ...
    @FindBy(how = How.CSS, using = suggestionWebElements)
    public List<WebElement> suggestion;
    @FindBy(how = How.LINK_TEXT, using = menuOptionWebElements)
    public WebElement menuOption;
    @FindBy(how = How.ID, using = mouseHoverWebElement)
